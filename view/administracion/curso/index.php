                  	...
                  	<table id="TablaEntidad" class="table table-bordered table-hover dataTable no-footer" width="100%">
	                    ...
	                    <tbody>
	                    	...
	                    	<tr>
                                ...
                                <?php endif ?>
                            	<td class="a_center">                            		
                            		<a href="?c=Curso&a=v_Actualizar&idCurso=<?php echo 
									$curso['idCurso']; ?>" class="btn btn-primary btn-xs " 
									data-toggle="tooltip" data-placement="top" title="Actualizar">
                                   		<i class="fa fa-pencil"></i>   
                               		</a>
                               		<a class="btn btn-danger btn-xs EliminarCurso" data-id="<?php echo 
									$curso['idCurso']; ?>" data-curso="<?php echo $curso['nombre']; ?>" 
